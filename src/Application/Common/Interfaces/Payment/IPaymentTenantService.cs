...
public interface IPaymentTenantService
{
    ...
    Task<Result<(string url, DateTimeOffset expiration)>> GenerateAccountLinkAsync(string accountId, string gymId, bool isOnboarding = false, CancellationToken cancellationToken = default);
