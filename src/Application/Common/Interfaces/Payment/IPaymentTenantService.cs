...
public interface IPaymentTenantService
{
    ...
    Task<Result<(string url, DateTime expiration)>> GenerateAccountLinkAsync(string accountId, string returnUrl, string refreshUrl, bool isOnboarding = false, CancellationToken cancellationToken = default)
