...
public class StripePriceService : IPaymentPriceService
{
    ...
    public async Task<Result<string>> CreatePriceAsync(
        string productId,
        Money priceMoney,
        bool isActive,
    ...
    public async Task<Result<string>> UpdatePriceAsync(
        string priceId,
        string productId,
        Money newPrice,
        bool isActive,
    ...
    )
    {
        try
        {
            ...
            await _priceService.UpdateAsync(
                priceId,
                priceUpdateOptions,
    ...
    )
    {
        try
        {
            var priceUpdateOptions = new PriceUpdateOptions { Active = isActive };
