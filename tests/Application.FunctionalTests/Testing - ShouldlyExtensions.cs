...
public partial class Testing
{
    ...
    public static void ShouldRequireAuthorization<TRequest>(params string[] expectedRoles)
        where TRequest : notnull
    {
        ...
        attributes
            .Any()
            .ShouldBeTrue($"{type.Name} should have at least one [Authorize] attribute");
        ...
        actualRoles.ShouldBe(
            cleanedExpectedRoles,
